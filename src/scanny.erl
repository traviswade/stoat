...
tokens(Cont, CharSpec, StartLocation) ->
	error_logger:info_msg("getting tokens:~p~n", [{Cont, CharSpec, StartLocation}]),
    tokens(Cont, CharSpec, StartLocation, []).
